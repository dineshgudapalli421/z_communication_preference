		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsaplhmrzcommunicationpreference-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzcommunicationpreference-display": {
								"semanticObject": "comsaplhmrzcommunicationpreference",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zcommunicationpreference",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zcommunicationpreference")
								}
							}
						}
					}
